...
namespace detail {
    ...
    struct _If { // type is _Ty2 for assumed false
    ...
    struct _If<true, _Ty1, _Ty2> { // type is _Ty1 for assumed true
    ...
    struct add_reference { // add reference
    ...
    struct add_reference<void> { // add reference
    ...
    struct add_reference<const void> { // add reference
    ...
    struct add_reference<volatile void> { // add reference
    ...
    struct add_reference<const volatile void> { // add reference
